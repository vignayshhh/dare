...
interface DareApprovedCinematicScreenProps {
  receiverName?: string;
...
export function DareApprovedCinematicScreen({
  receiverName,
  receiverUsername,
  isExiting = false,
}: DareApprovedCinematicScreenProps) {
  const displayName =
    receiverName?.trim() ||
    stripAtSymbol(receiverUsername) ||
    "your challenger";
  ...
  return (
    <div className="screen-container relative items-center justify-center overflow-hidden bg-[#050805]">
      <div
        ...
        style={{
          animation: isExiting
            ? "dareApprovedBackdropOut 0.7s ease forwards"
            : "dareApprovedBackdropIn 0.4s ease forwards",
        }}
      >
      ...
      <div
        ...
        style={{
          animation: isExiting
            ? "dareApprovedCardOut 0.65s ease forwards"
            : "dareApprovedCardIn 0.72s cubic-bezier(0.22,1,0.36,1) forwards",
        }}
      >
        <div className="relative mx-auto mb-12 flex h-56 w-56 items-center justify-center sm:h-64 sm:w-64">
          <div
            ...
            style={{ animation: "dareApprovedHalo 2.2s ease-in-out infinite" }}
          />
          <div
            className="absolute inset-2 rounded-full border border-[#00ff88]/35"
            style={{ animation: "dareApprovedRing 2.6s ease-out infinite" }}
          />
          <div
            className="absolute inset-6 rounded-full border border-white/12"
            style={{
              animation: "dareApprovedRing 2.6s ease-out infinite 0.5s",
            }}
          />
          ...
          <div
            ...
            style={{
              animation:
                "dareApprovedIconPop 0.85s cubic-bezier(0.22,1,0.36,1) forwards",
            }}
          >
            <BadgeCheck
              size={82}
              className="text-[#8bffbf] sm:h-[88px] sm:w-[88px]"
            />
          </div>
          ...
          <Sparkles
            ...
            style={{
              animation: "dareApprovedSparkle 1.8s ease-in-out infinite",
            }}
          />
          <Sparkles
            size={20}
            ...
            style={{
              animation: "dareApprovedSparkle 1.8s ease-in-out infinite 0.35s",
            }}
          />
        </div>
        ...
        <div
          className="max-w-md"
          style={{ animation: "dareApprovedFloat 3.2s ease-in-out infinite" }}
        >
          <h1 className="text-4xl font-black tracking-tight text-white sm:text-5xl">
            Dare Approved
          </h1>
          <p className="mt-5 text-base leading-7 text-[#c7d2c9] sm:text-lg">
            {displayName} nailed the submission.
          </p>
        </div>
      </div>
    </div>
...
export default DareApprovedCinematicScreen;
